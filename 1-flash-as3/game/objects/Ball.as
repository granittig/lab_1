package game.objects {
	...
	*/
	...
	public class Ball extends Sprite {
		...
		// свойства шарика:
		public var ballXSpeed:Number = 8.0; // скорость
		public var ballYSpeed:Number = 8.0; // скорость
		private var paddle:Paddle; // отбивающая доска
		private var gameplay:Gameplay; // глобальные параметры игры

		public function Ball(paddle:Paddle, gameplay:Gameplay){
			// отрисуем шарик
		...
		private function calcBallAngle():void {
			...
			*/
			...
			var hitPercent:Number = (ballPosition / (paddle.width/2 - this.width/2)) - .5;
